...
$sql = "UPDATE rental set type = '$type', area = '$area', mortgage = '$mortgage', rent = '$rent',hold = '$hold',floors = '$floors',floor = '$floor',upf = '$upf',unit = '$unit',cold_heat = '$cold_heat',parking = '$parking',elevator = '$elevator',terrace = '$terrace',facades='$facades',kitchen='$kitchen',service='$service',phone='$phone',address='$address',discription='$discription', owner='$owner' WHERE id = '$caseId' ";
